...
public class NPC_cuconato extends Entity{

    public NPC_cuconato(GamePanel gp){
        super(gp);
    ...
    public void getPlayerImage(){       //legge le immagini del player
        ...
        try {
            ...
            up1 = ImageIO.read(getClass().getResourceAsStream("/res/npc/cuconato/cuconato2.png"));
            down1 = ImageIO.read(getClass().getResourceAsStream("/res/npc/cuconato/cuconato0.png"));
            left1 = ImageIO.read(getClass().getResourceAsStream("/res/npc/cuconato/cuconato3.png"));
            right1 = ImageIO.read(getClass().getResourceAsStream("/res/npc/cuconato/cuconato1.png"));
