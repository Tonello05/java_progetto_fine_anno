...
public class NPC_abu extends Entity{
    ...
    public void getPlayerImage(){       //legge le immagini del player
        ...
        try {
            ...
            up1 = ImageIO.read(getClass().getResourceAsStream("/res/npc/abu/abu2.png"));
            down1 = ImageIO.read(getClass().getResourceAsStream("/res/npc/abu/abu0.png"));
            left1 = ImageIO.read(getClass().getResourceAsStream("/res/npc/abu/abu3.png"));
            right1 = ImageIO.read(getClass().getResourceAsStream("/res/npc/abu/abu1.png"));
