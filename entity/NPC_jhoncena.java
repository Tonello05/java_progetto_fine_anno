...
public class NPC_jhoncena extends Entity{

    public NPC_jhoncena(GamePanel gp){
        super (gp);
    ...
    public void getPlayerImage(){       //legge le immagini del player
        ...
        try {
            ...
            up1 = ImageIO.read(getClass().getResourceAsStream("/res/npc/jhoncena/JhonCena.png"));
            down1 = ImageIO.read(getClass().getResourceAsStream("/res/npc/jhoncena/JhonCena.png"));
            left1 = ImageIO.read(getClass().getResourceAsStream("/res/npc/jhoncena/JhonCena.png"));
            right1 = ImageIO.read(getClass().getResourceAsStream("/res/npc/jhoncena/JhonCena.png"));
